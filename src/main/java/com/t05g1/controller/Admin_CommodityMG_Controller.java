...
public class Admin_CommodityMG_Controller {
	...
	public Map<String, Object> saveImgInfo(int colourId, int commId, String imgUrls) {
        ...
        Integer res =imagesService.insertByAll(colourId, commId, urls[0], urls[0], urls[0]);
	 ...
	 */
    @ResponseBody
    @RequestMapping("showColourData.do")
    public Map<String,Object> showColour(
    		@RequestParam(value = "commoId", required = false)Integer commoId    	
    		){
    	
    	List<Colour> datas = colourService.selectColorById(commoId);
    	Map<String,Object> map = new HashMap<>();
   ...
   @ResponseBody
   @RequestMapping("addColour.do")
   public Map<String,Object> addColour(Colour colour){
	   
	   int res = colourService.insertSelective(colour);
		Map<String,Object> map = new HashMap<>();
